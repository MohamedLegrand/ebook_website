      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8 mb-8 sm:mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-3 mb-4">
              <div className="w-14 h-14 sm:w-16 sm:h-16 flex-shrink-0">
                <img
                  ...
                  onError={(e) => {
                    // Fallback si le logo n'est pas trouvé : affiche un texte stylisé
                    e.target.style.display = 'none';
                    e.target.nextSibling.style.display = 'flex';
                  }}
                />
                <div className="w-full h-full bg-gradient-to-br from-amber-500 to-blue-700 rounded-xl flex items-center justify-center hidden">
                  <span className="text-white font-black text-lg">MTHS</span>
                </div>
              </div>
              <div>
            ...
            {/* ===== RÉSEAUX SOCIAUX : Logos seuls, sans fond ni bordure ===== */}
            <div className="flex gap-3 sm:gap-4 mb-4">
              {/* Facebook - Logo seul */}
              <a 
                href="https://facebook.com/mths" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="group inline-flex items-center justify-center hover:opacity-80 transition-opacity"
              ...
              >
                ...
                />
                {/* Fallback SVG caché par défaut */}
                <svg className="w-6 h-6 sm:w-7 sm:h-7 text-blue-400 hidden group-hover:text-blue-300 transition-colors" fill="currentColor" viewBox="0 0 24 24" style={{display: 'none'}}>
              ...
              >
                <img 
                  src="/images/icones/whatsapp.jpg" 
                  alt="WhatsApp" 
                  className="w-6 h-6 sm:w-7 sm:h-7 object-contain"
                  onError={(e) => {
                    // Fallback SVG si l'image n'est pas trouvée
                ...
                />
                {/* Fallback SVG caché par défaut */}
                <svg className="w-6 h-6 sm:w-7 sm:h-7 text-green-400 hidden group-hover:text-green-300 transition-colors" fill="currentColor" viewBox="0 0 24 24" style={{display: 'none'}}>
            ...
            <div className="lg:col-span-2">
              ...
              <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-2 max-w-md">
                <input
                  ...
                  required
                  className="flex-1 px-3 py-2 text-sm border-2 border-blue-600 bg-white/10 text-white placeholder-blue-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-400 focus:bg-white/20 transition-all"
                />
                <button
                  type="submit"
                  className="w-full sm:w-auto bg-gradient-to-r from-amber-500 to-blue-700 text-white px-4 py-2 rounded-lg hover:from-amber-600 hover:to-blue-800 transition-all duration-300 text-sm font-bold shadow-lg hover:shadow-xl flex items-center justify-center gap-2 whitespace-nowrap"
          ...
          <div className="border-t border-blue-700 pt-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
              ...
              <div className="flex items-center gap-2 text-blue-300 text-xs">
                ...
                <span className="font-semibold">SSL Sécurisé</span>
              </div>
            </div>
          </div>
        </div>
