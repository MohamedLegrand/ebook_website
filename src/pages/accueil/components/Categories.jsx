...
const WhyChooseUs = () => {
  ...
  const livres = [
    ...
    { id: 27, titre: "Le Cameroun dans les flammes", auteur: "Centre MTHS", desc: "Guide complet pour obtenir la délivrance et la victoire contre le Diable, les Démons et les Sorciers.", prixFCFA: 6500, image: "/images/livre27/livre27_1.png", format: ["Papier", "PDF"],        pages: 310, stock: 20, type: "Livre",  isbn: "978-2-954-12353-1", datePublication: "2023", langue: "Français" },
    { id: 28, titre: "L'Hygiène de l'âme", auteur: "Centre MTHS", desc: "Guide complet pour obtenir la délivrance et la victoire contre le Diable, les Démons et les Sorciers.", prixFCFA: 6500, image: "/images/livre28/livre28_1.png", format: ["Papier", "PDF"],        pages: 310, stock: 20, type: "Livre",  isbn: "978-2-954-12353-1", datePublication: "2023", langue: "Français" },
