...
function Login() {
  ...
  const handleGoogleLogin = () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      alert("Redirection vers Google... (simulation)");
    }, 1000);
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50/90 via-white to-blue-50/90 p-3 overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-32 h-32 bg-blue-300/10 rounded-full blur-xl animate-pulse-slow"
      ...
      <div className="w-full max-w-sm relative">
        ...
        <div className="relative bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-blue-100 p-5 animate-slideUp">
          ...
          <div className="absolute -top-2 -right-2 w-4 h-4 bg-blue-400 rounded-full blur-sm animate-ping-slow" style={{ animationDelay: "0.5s" }}></div>
          ...
          <div className="absolute -bottom-2 -right-2 w-4 h-4 bg-blue-400 rounded-full blur-sm animate-ping-slow" style={{ animationDelay: "1.5s" }}></div>
          ...
          <form className="space-y-3" onSubmit={handleSubmit}>
            ...
            <div className="animate-fadeInLeft" style={{ animationDelay: "0.1s" }}>
              <div className="relative group">
                ...
                />
                <div className={`absolute left-3 top-1/2 transform -translate-y-1/2 transition-all duration-300 ${email ? "text-blue-500 scale-110" : "text-gray-400"}`}>
            ...
            <div className="animate-fadeInLeft" style={{ animationDelay: "0.2s" }}>
              <div className="relative group">
                <input
                  ...
                  placeholder="********"
                  className={`w-full px-3 py-2 pl-10 pr-10 text-sm border rounded-lg transition-all duration-300 group-hover:scale-[1.02] ${
                    formErrors.password
                      ? "border-red-400 bg-red-50 focus:ring-2 focus:ring-red-200"
                      : "border-blue-200 focus:border-blue-400 focus:ring-2 focus:ring-blue-200"
                  } outline-none`}
                />
                <div className={`absolute left-3 top-1/2 transform -translate-y-1/2 transition-all duration-300 ${password ? "text-blue-500 scale-110" : "text-gray-400"}`}>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-blue-500 transition-all duration-200 focus:outline-none"
                  tabIndex={-1}
                >
                  {showPassword ? (
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-transparent via-blue-50/30 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000 pointer-events-none"></div>
              </div>
            ...
            <div className="flex items-center justify-between text-xs animate-fadeIn" style={{ animationDelay: "0.3s" }}>
              <label className="flex items-center gap-2 text-gray-600 cursor-pointer hover:text-blue-600 transition-all duration-300 hover:scale-105">
                <div className="relative">
                  <input
                    ...
                    className="sr-only"
                  />
                  <div className={`w-3.5 h-3.5 border rounded flex items-center justify-center transition-all duration-300 ${rememberMe ? "bg-blue-500 border-blue-500 scale-110" : "border-gray-300"}`}>
                    {rememberMe && (
              ...
              <a href="#" className="text-blue-500 hover:text-blue-700 text-xs hover:underline transition-all duration-300 hover:scale-105">
                Mot de passe oublié ?
              </a>
            </div>
          ...
          {/* Lien inscription */}
          <div className="text-center mt-4 pt-3 border-t border-blue-50 animate-fadeIn" style={{ animationDelay: "0.7s" }}>
            <p className="text-xs text-gray-500">
              Pas encore de compte ?{" "}
              <a href="/register" className="text-blue-500 hover:text-blue-700 font-medium hover:underline transition-all duration-300 hover:scale-105 inline-block">
                Créer un compte
              </a>
            </p>
          </div>
      ...
      <style jsx>{`
        ...
        @keyframes glow { 0%, 100% { opacity: 0.2; transform: scale(1); } 50% { opacity: 0.4; transform: scale(1.02); } }
        ...
        @keyframes ping-slow { 0% { transform: scale(1); opacity: 0.7; } 80%, 100% { transform: scale(2); opacity: 0; } }
        @keyframes text-glow { 0%, 100% { text-shadow: 0 0 5px rgba(59, 130, 246, 0); } 50% { text-shadow: 0 0 10px rgba(59, 130, 246, 0.3); } }
        @keyframes check { 0% { stroke-dasharray: 50; stroke-dashoffset: 50; } 100% { stroke-dasharray: 50; stroke-dashoffset: 0; } }
        ...
        .animate-check { animation: check 0.3s ease-out; }
